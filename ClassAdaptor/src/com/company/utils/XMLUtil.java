...
public class XMLUtil {
    ...
    public static Object getBean() throws Exception {
        ...
        //获取包含类名的文本结点
        NodeList nodeList = document.getElementsByTagName("Adaptor");
        Node databaseTypeNode = nodeList.item(0).getFirstChild();
        String adaptor = databaseTypeNode.getNodeValue().trim();

        //通过类名生成实例对象并将其返回
        Class<?> clazz  = Class.forName("com.company.adaptor."+adaptor+"Adaptor");
